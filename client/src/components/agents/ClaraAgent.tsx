...
const ClaraAgent: React.FC = () => {
  ...
  // Traditional chat view component
  const TraditionalChatView = () => (
    <WindowContent
      variant="ghost"
      padding="none"
  ...
  return (
    ...
    >
      <div className="w-full max-w-full flex flex-col h-full relative overflow-hidden">
        {/* Header with tagline */}
        <div className="sticky top-0 z-10 mb-2 flex justify-between items-center px-2 bg-black/20 backdrop-blur-sm py-1 rounded-b-md">
          ...
          <button 
            ...
            className="px-2 py-1 ml-2 text-xs shrink-0 bg-black/20 hover:bg-black/40 rounded-md backdrop-blur-sm transition-all"
          >
        ...
        <div className="flex-1 flex flex-col overflow-hidden relative min-h-0">
          ...
          {carouselView ? <CarouselChatView /> : <TraditionalChatView />}
