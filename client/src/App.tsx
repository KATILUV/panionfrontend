...
function RegisterAgents() {
  ...
  useEffect(() => {
    ...
    // Note: Primary taskbar reset is now handled by the TaskbarFixer component
    // We only need to ensure that the agent icons are properly registered
    ...
    const feedbackIcon = `
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M8 12V12.01" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M16 12V12.01" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      </svg>
    `;
    
    agentStore.registerAgent({
      id: 'feedback',
      title: 'UI Feedback Demo',
      icon: feedbackIcon,
    ...
    agentStore.registerAgent({
      ...
      title: 'Daddy Data',
      icon: daddyDataIcon,
      component: () => <DaddyDataAgent />,
      defaultPosition: { x: 300, y: 300 },
      defaultSize: { width: 900, height: 680 }
    });
    
    // WebSocket functionality has been integrated into Panion
  }, []);
