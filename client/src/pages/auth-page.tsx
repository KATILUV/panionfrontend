...
const AuthPage = () => {
  ...
  return (
    <div className={`min-h-screen w-full flex items-center justify-center bg-gradient-to-br ${getGradient()}`}>
      <div className="container relative flex flex-col lg:flex-row items-center justify-center gap-10 p-4">
        {/* Auth Form */}
        <Card className={`w-full max-w-md border ${getCardBgClasses()} backdrop-blur-xl`}>
                ...
                <Form {...loginForm}>
                  <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className={getTextColor()}>Username</FormLabel>
                          <FormControl>
                            <Input 
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className={getTextColor()}>Password</FormLabel>
                          <FormControl>
                            <Input 
                              type="password" 
                ...
                <Form {...registerForm}>
                  <form onSubmit={registerForm.handleSubmit(onRegisterSubmit)} className="space-y-4">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className={getTextColor()}>Confirm Password</FormLabel>
                          <FormControl>
                            <Input 
                              type="password" 
        ...
        {/* Hero Section */}
        <div className="w-full max-w-md text-center lg:text-left flex flex-col">
          <h1 className={`text-4xl lg:text-5xl font-bold mb-4 ${getTextColor()}`}>
            Panion
          </h1>
          ...
          <p className={`mb-6 ${getMutedTextColor()}`}>
          ...
          <div className="space-y-4">
            ...
            <div className={`flex items-center gap-3 ${getTextColor()}`}>
              ...
              <div>
                ...
                <p className={getMutedTextColor()}>Personalize themes, accent colors, and layouts.</p>
              </div>
            </div>
          </div>
        </div>
