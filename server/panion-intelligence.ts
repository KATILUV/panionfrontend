 ...
 * Implements advanced AI capabilities for Panion
 */
...
Response:
    ...
    try {
      ...
      systemLog.error(`Failed to parse insights JSON: ${error}`, 'panion-intelligence');
      return [];
    }
...
export async function generateReasoningPaths(
  ...
  try {
    ...
    const prompt = `
You are Panion, an advanced AI assistant with exceptional problem-solving capabilities.
...
Response:
    ...
    try {
      ...
      systemLog.error(`Failed to parse reasoning paths JSON: ${error}`, 'panion-intelligence');
      return [];
    }
...
export async function decomposeTask(
  ...
  try {
    ...
    const prompt = `
You are Panion, an advanced AI assistant with exceptional task management capabilities.
...
Response:
    ...
    try {
      ...
      systemLog.error(`Failed to parse task decomposition JSON: ${error}`, 'panion-intelligence');
...
export async function verifyResult(
  ...
  try {
    ...
    const prompt = `
You are Panion, an advanced AI assistant with metacognitive verification capabilities.
...
Response:
    ...
    try {
      ...
      systemLog.error(`Failed to parse verification JSON: ${error}`, 'panion-intelligence');
