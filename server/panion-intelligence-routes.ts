/**
 * Panion Intelligence Routes
 * Express routes for enhanced Panion capabilities
 */
...
router.get('/api/panion/intelligence/insights/:sessionId', async (req: Request, res: Response) => {
  try {
    ...
    systemLog.error(`Error getting insights: ${error}`, 'panion-intelligence');
    res.status(500).json({
...
router.post('/api/panion/intelligence/insights/:sessionId/generate', async (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params;
    ...
    systemLog.error(`Error generating insights: ${error}`, 'panion-intelligence');
    res.status(500).json({
...
router.post('/api/panion/intelligence/reasoning-paths', async (req: Request, res: Response) => {
  try {
    ...
    systemLog.error(`Error generating reasoning paths: ${error}`, 'panion-intelligence');
    res.status(500).json({
...
router.post('/api/panion/intelligence/decompose-task', async (req: Request, res: Response) => {
  try {
    ...
    systemLog.error(`Error decomposing task: ${error}`, 'panion-intelligence');
    res.status(500).json({
...
// Get a task by ID
router.get('/api/panion/intelligence/tasks/:taskId', (req: Request, res: Response) => {
  try {
    ...
    systemLog.error(`Error getting task: ${error}`, 'panion-intelligence');
    res.status(500).json({
...
router.post('/api/panion/intelligence/update-subtask', (req: Request, res: Response) => {
  try {
    ...
    systemLog.error(`Error updating subtask: ${error}`, 'panion-intelligence');
    res.status(500).json({
...
// Verify a result
router.post('/api/panion/intelligence/verify', async (req: Request, res: Response) => {
  try {
    ...
    systemLog.error(`Error verifying result: ${error}`, 'panion-intelligence');
    res.status(500).json({
...
// Get active sessions
router.get('/api/panion/intelligence/sessions', (req: Request, res: Response) => {
  try {
    ...
    systemLog.error(`Error getting active sessions: ${error}`, 'panion-intelligence');
    res.status(500).json({
